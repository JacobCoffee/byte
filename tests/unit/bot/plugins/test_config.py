...
class TestConfigCog:
    ...
    @pytest.mark.asyncio
    async def test_config_autocomplete(self, mock_bot: Bot, mock_interaction: Interaction, mock_config_options: list[dict]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_config_autocomplete_filters_by_current(self, mock_bot: Bot, mock_interaction: Interaction, mock_config_options: list[dict]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_config_rule_with_setting(self, mock_bot: Bot, mock_interaction: Interaction, mock_config_options: list[dict]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_config_rule_with_invalid_setting(self, mock_bot: Bot, mock_interaction: Interaction, mock_config_options: list[dict]) -> None:
    ...
    @pytest.mark.asyncio
    async def test_config_rule_without_setting(self, mock_bot: Bot, mock_interaction: Interaction, mock_config_options: list[dict]) -> None:
