...
1. Run ``make install`` to install `uv <https://docs.astral.sh/uv/>`_, all dependencies, and prek hooks
...
1. `Fork <https://github.com/JacobCoffee/byte/fork>`_ the `Byte Bot repository <https://github.com/>`_
...
2. `Draft a new release <https://github.com/JacobCoffee/byte/releases/new>`_ on GitHub

   * Use ``vMAJOR.MINOR.PATCH`` (e.g. ``v1.2.3``) as both the tag and release title
   * Fill in the release description. You can use the "Generate release notes" function to get a draft for this
3. Commit your changes and push to ``main``
4. Publish the release
5. Check that the "publish" `action <https://github.com/JacobCoffee/byte/actions>`_ has run successfully
